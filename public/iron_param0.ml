...
let property_values_flag ~switch =
  ...
  map (flag switch ~doc:(sprintf "%s user-defined properties" syntax)
    ...
    ~f:(function
      | [] -> None
      | _::_ as alist -> Some (String.Table.of_alist_exn alist))
;;
