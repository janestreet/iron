...
: (i.e. count, mean, etc.) if the switch -show-by-stat is supplied.
: 
: 
: === flags ===
: 
...
:   [-show-by-stat]             draw tables by stat
:   [-stats STAT,[STAT...]]     select stats to show count|max|mean|min|total
:   [-help]                     print this help text and exit
:                               (alias: -?)
